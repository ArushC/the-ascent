import type { PlatformPowerupState } from "../powerup/Powerup";
import type { PlatformSpringState } from "../spring/Spring";
...
export interface Platform extends PlatformSpringState, PlatformPowerupState {
