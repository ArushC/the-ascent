...
const shapeRules = [
  "Return only one flat JSON object with exactly these top-level keys: title, seed, modifiers.",
  "Do not include challengeDate, date, challenge, metadata, or a nested wrapper.",
  "title: 1-40 chars and must name the challenge's supported gameplay mechanic.",
